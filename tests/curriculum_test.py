...
video = Video(vtype='face', face_predictor_path='./shape_predictor_68_face_landmarks.dat')
#video.from_video('~/LipNet/evaluation/samples/id2_vcd_swwp2s.mpg')
video.from_video('./comp101.mpg')

#align = Align(absolute_max_string_len=32, label_func=text_to_labels).from_file('evaluation/samples/swwp2s.align')
align = Align(absolute_max_string_len=32, label_func=text_to_labels).from_file('./comp101.align')
